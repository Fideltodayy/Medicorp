...
import Logo from '../images/logo/cinv-logo.jpg';
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-app2 lg:static lg:translate-x-0 ${
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          ...
          <div className=' flex'>
            <img src={Logo} className=' w-7 h-7 rounded-full mr-5' alt="Logo" />
            <h4 className=' font-bold lowercase' style={{ color:'white'}}>Fahari Agritech</h4>
          </div>
        </NavLink>
